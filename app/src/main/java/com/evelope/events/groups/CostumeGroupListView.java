...
public class CostumeGroupListView extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (CurrentUser.get().getU_id() == adminID[position])
            viewHolder.relativeLayout_groups_listview.setBackgroundResource(R.color.dot_active_screen3);
        else
        ...
        viewHolder.tv_eventName.setText(eventName[position]);
